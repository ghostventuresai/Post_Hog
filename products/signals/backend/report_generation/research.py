...
- A transient, self-resolving, or non-blocking issue affecting a single route or component is **P3 or P4**, unless your research shows it is frequent or high-impact.
- If you could not quantify the impact (frequency, affected user/session count, error rate) from data, default the priority **down one level** — an unmeasured issue is rarely urgent.
- Reserve **P0/P1** for issues you have evidence affect many users or break a core flow.

...
/**
 * Eagerly provision a sandbox for a sandbox-runtime conversation while the user is typing (05_SANDBOX § 8). POST warms a Run in-process (no pending message); DELETE releases it if the user abandons. Both idempotent and sandbox runtime only.
 */

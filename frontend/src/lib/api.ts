...
const api = {
    ...
    conversations: {
        ...
        /**
         * Eagerly provision a sandbox while the user is typing (05_SANDBOX § 8). Sandbox runtime
         * only; idempotent. Returns 204 — warms a Run in-process with no pending message so the
         * session boots and idles awaiting input. Submitting later follows the in-progress branch.
         */
        ...
        /**
         * Release / cancel an eager prewarm if the user abandons (05_SANDBOX § 8). Idempotent;

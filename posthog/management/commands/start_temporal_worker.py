...
from products.referrals.backend.temporal import (
    RESEARCH_ACTIVITIES as REFERRALS_RESEARCH_ACTIVITIES,
    RESEARCH_WORKFLOWS as REFERRALS_RESEARCH_WORKFLOWS,
    STATUS_ACTIVITIES as SOCIAL_REFERRAL_STATUS_ACTIVITIES,
    STATUS_WORKFLOWS as SOCIAL_REFERRAL_STATUS_WORKFLOWS,
)
...
_task_queue_specs = [
    ...
    (
        ...
        + SOCIAL_REFERRAL_STATUS_WORKFLOWS,
        ...
        + SOCIAL_REFERRAL_STATUS_ACTIVITIES,
    ),
    (
    ...
    (
        ...
        TASKS_WORKFLOWS + REFERRALS_RESEARCH_WORKFLOWS,
        TASKS_ACTIVITIES + REFERRALS_RESEARCH_ACTIVITIES,
    ),
    (

...
from posthog.temporal.subscriptions.ai_subscription.activities import (
...
_IS_OVER_BUDGET = "posthog.temporal.subscriptions.ai_subscription.activities.is_team_over_ai_credit_budget"
_CREDIT_LIMITED_EMAIL = "posthog.temporal.subscriptions.ai_subscription.delivery.EmailMessage"
